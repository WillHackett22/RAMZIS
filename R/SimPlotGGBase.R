...
#' @param ObservedSimObj List produced by ObservedSimilarityStats()
...
#'
#' @examples #
SimPlotGGBase<-function(PlotTitle,dfSim,RefName,OverlapData,ObservedSimObj,Confidence=NULL,legend.bool=T,themepick=theme_RAMZIS){
