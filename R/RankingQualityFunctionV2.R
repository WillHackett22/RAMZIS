#' RankingQualityFunctionV2 combines ranking and QC data and produces the final output
#'
...
#'
#' @examples #
RankingQualityFunctionV2<-function(SimilarityObj,InternalSimObj1,InternalSimObj2){
  CQData<-ContributionQualityCheckFunction(SimilarityObj,InternalSimObj1,InternalSimObj2)
  RData<-RankingByZScoreV2(SimilarityObj)
